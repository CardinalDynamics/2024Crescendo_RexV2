...
public class LeftAuto extends SequentialCommandGroup{
    public LeftAuto(Drivetrain drivetrain, Intake intake, Rotator rotator, Shooter shooter) {
        addCommands(
            ...
            (new RunCommand(() -> drivetrain.arcadeDrive(-.5, .1), drivetrain)).withTimeout(1.5)
        );
